...
<table width="780" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
	...
	<form action="LoginfoAction.do?method=filterIndex" method="post" name="mf">
	<input type="hidden" name="page" value="1"/>
	<jsp:include page="MyFilter.jsp"></jsp:include>
<table width="88%" cellspacing="0">
	...
	<c:forEach items="${indexLogin}" var="a">
		<tr>
			<td><a href='LoginfoAction.do?method=filterFind&fwid=${a.fwid }'>${a.title }</a></td>
			<td align='center' style='height:30px;'>${a.zj }元</td>
			<td align='center'>${a.fdate}</td>
		</tr>
	</c:forEach>
	<tr>
		<td colspan='3'><hr/></td>
